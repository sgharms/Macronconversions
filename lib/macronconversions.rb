...
== Example Code
  ...
  puts Text::Latex::Util::Macronconversions.convert("mon\\={e}re", 'mc')
  puts Text::Latex::Util::Macronconversions.convert('to bring up, educate: \={e}duc\={o}, \={e}duc\={a}re, \={e}duc\={a}v\={\i}, \={e}ducatus; education, educator, educable', 'mc')
